                ...
                <div className="flex items-center justify-between pt-2 border-t border-stone-50">
                  {isEditing ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-stone-200 bg-stone-50 active:bg-stone-100 transition"
                    >
                      <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#78716c" strokeWidth="2" strokeLinecap="round">
                        <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
                      </svg>
                      <span className="text-xs text-stone-500">
                        Resets {resetDay === 1 ? '1st' : `${resetDay}th`} · since {cycleStartStr}
                      </span>
                    </button>
                  )}
